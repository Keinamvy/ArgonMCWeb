...
<div>
  <div class="home-container">
    <header data-thq="thq-navbar" class="home-navbar-interactive">
      <img
        alt="logo"
        src="https://i.imgur.com/tZBuP2B.png"
        class="home-image"
      />
    ...
    <div class="home-container01">
      <div class="home-container02">
        <form enctype="application/x-www-form-urlencoded" class="home-form">
          <div class="home-container03">
            <label class="home-text05">« Nạp Thẻ »</label>
          </div>
          <div class="home-container04">
            ...
            <input
              type="text"
              required="true"
              placeholder="Nhập chính xác tài khoản Minecraft!!"
          ...
          <div class="home-container05">
            ...
            <select required="true" class="home-select"></select>
          </div>
          <div class="home-container06">
            ...
            <select required="true" class="home-select1">
